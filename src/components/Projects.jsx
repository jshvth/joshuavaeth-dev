  ...
  const projects = [
    {
      ...
      description: [
        "AI-powered management of manga collections with automated release tracking.",
        "Integration of Jikan & AniList APIs for real-time data.",
        "Backend using Supabase (Postgres & Auth) for profiles and social features such as Follow/Search.",
        "Cron pipeline via Edge Functions & pg_cron scans for updates every 3 days.",
      ],
      tags: [
        "React",
        "Supabase",
    ...
    },
    {
      ...
      description: [
        "A platform for manga stories with branching narratives and a visual tree structure.",
        "Full-stack development using Flask, React and SQLAlchemy persistence.",
        "A visual editor based on React Flow and Dagre for displaying storylines.",
        "Features: JWT authentication, image uploads, dark mode and EN/DE localisation.",
      ],
