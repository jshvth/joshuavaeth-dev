...
const About = () => {
  return (
    <section
      id="about"
      className="min-h-screen flex flex-col justify-center bg-dark-bg py-16"
    >
      <div className="max-w-[1600px] mx-auto w-full px-6 md:px-20">
        ...
        <div className="flex flex-col lg:flex-row gap-10 md:gap-12 items-start">
          ...
          <div className="w-full lg:w-1/3 order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full aspect-[4/5] md:aspect-[3/4] max-w-[400px] overflow-hidden rounded-sm grayscale hover:grayscale-0 transition-all duration-500 border border-gray-800">
              <img
                src="joshua.jpg"
                alt="Joshua Väth"
